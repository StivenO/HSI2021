...
<body>
    <div class="container">
        ...
        <h1 class="h3 mb-4 text-gray-800">Agregar una Categoría</h1>

        <form action="{{url('category')}}" method="POST" class="user">
            @csrf
            <!-- Fila -->
            <div class="row">
                    ...
                    <div class="p-3 py-5">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary text-center">Formulario para agregar una Categoría</h6>
                            </div>
                            <div class="card-body">
                                <div class="row mt-2">
                                    <div class="col-md-8">
