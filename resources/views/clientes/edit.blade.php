...
<body>
	<div class="container">
		...
		<form action="{{ url('clientes/edit/'.$data->idperson ) }}" method="POST" class="user">
			@csrf
			<!-- Fila -->
			<div class="row">
							...
							<div class="card-body">
								<div class="row mt-2">
									<div class="col-md-4 col-sm-6">
										...
										<select name="typeid_id" class="select-acostica form-control" required>
								...
								<div class="row mt-2">
									...
									<div class="col-md-4 col-sm-6">
										...
										<input type="submit" name="" value="Editar Cliente" class="btn btn-success btn-user btn-block"></input>
									</div>
								</div>
							</div>
						</div>
