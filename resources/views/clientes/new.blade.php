...
<body>
	<div class="container">
		...
		<a href="{{ url('clientes') }}" class="btn btn-danger float-right"><i class="fas fa-window-close"></i> Cancelar</a>

		<!-- Encabezado de página -->
		<h1 class="h3 mb-4 text-gray-800">Agregar un Cliente</h1>
		<form action="{{ url('clientes') }}" method="POST" class="user">
			@csrf
			<!-- Fila -->
			<div class="row">
					...
					<div class="p-3 py-3">
						...
						<div class="card shadow col-md-12 col-sm-12 col-xs-10 col-auto" style="width: 60rem;">
							<div class="card-header py-3">
								<h6 class="m-0 font-weight-bold text-primary text-center">Formulario para agregar un Cliente</h6>
							</div>
							<div class="card-body">
								<div class="row mt-2">
									...
									<div class="col-md-4 col-sm-6">
										<label class="labels">Nombres del Cliente</label>
										<input name="nomperson" placeholder="Nombres" class="form-control form-control-user" required>
									</div>
								</div>
								<div class="row mt-2">
									<div class="col-md-4 col-sm-6">
										<label class="labels">Apellidos del Cliente</label>
								...
								<div class="row mt-2">
									...
									<div class="col-md-4 col-sm-6">
										...
										<input type="submit" name="" value="Crear Cliente" class="btn btn-success btn-user btn-block"></input>
									</div>
								</div>
							</div>
						</div>
